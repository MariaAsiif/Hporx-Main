...
import SearchModal from '../AdminModels/SearchModel';
// import Notifications from '../components/DropdownNotifications';
// import Help from '../components/DropdownHelp';
// import UserMenu from '../components/DropdownProfile';
import GenericeModel from '../../../utils/popup/GenericModel';
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 -mb-px">
          ...
          <div className="flex items-center space-x-3">
            ...
            <GenericeModel id="search-modal" data={<SearchModal />} modalOpen={searchModalOpen} setModalOpen={setSearchModalOpen} />
