          ...
          <div className='absolute z-20 w-full'>
            ...
            <div className="sidenavcanvas">
              <ul>
                ...
                <li>
                  <Link to="/">INHALATE</Link>
                </li>
                <li>
                  <Link to="/">VAPORIZE</Link>
                </li>
                <li>
                  <Link to="/">PORTABLES</Link>
                </li>
                <li>
                  <Link to="/">CHILLUMS</Link>
                </li>
                <li>
                  CULTIVATE <i className="fas fa-angle-down"></i>
                </li>
                <li>
                  <Link to="/">DIAGNOSE </Link>
                </li>
                <li>
                  PRESCRIBE <i className="fas fa-angle-down"></i>
                </li>
                <li>
                  MARKETPLACE <i className="fas fa-angle-down"></i>
                </li>
                <li>
