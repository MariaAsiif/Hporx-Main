    ...
    return (
        <div className='bscontainer-fluid' id={id}>
            <ChillumMainContainer>
                ...
                <div onClick={() => setToggle(!toggle)} className="accordion-item ml-[30px] mr-[30px] bg-white border border-gray-200">
        ...
        transition
        focus:outline-none
      " type="button" style={{ justifyContent: 'inherit' }} data-bs-target="#collapseTwo" aria-expanded="false"
