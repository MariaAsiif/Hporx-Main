...
// import GenerecService from "../../../../utils/api/GenericService";
// import { HOSTNAME } from '../../../../utils/api/CallApi';
    ...
    <>
      ...
      <div className='bscontainer-fluid mb-4 ' id="input_Select">
        <div className='grid grid-cols-8 gap-3 pt-3'>
          <div className=' inp'>
            <select className='w-[21.5rem] border focus:outline-none rounded-md lg:w-full md:w-full  select_op text-sm flex items-center p-3 ' name="country" value={locationModel.country} onChange={handleChangeCountryStateCity}  >
          ...
          <div className=' inp'>
            <select className='w-[21.5rem] border focus:outline-none rounded-md lg:w-full md:w-full select_op text-sm flex items-center  p-3' name="state" value={locationModel.state} onChange={handleChangeCountryStateCity}  >
          ...
          <div className=' inp'>
            <select className='w-[21.5rem] border focus:outline-none rounded-md lg:w-full md:w-full select_op text-sm flex items-center  p-3' name="city" value={locationModel.city} onChange={handleChangeCountryStateCity}  >
          ...
          <div className=' inp'>
            <select className='w-[21.5rem] border focus:outline-none rounded-md lg:w-full md:w-full select_op text-sm flex items-center  p-3' name="services" value={locationModel.services} onChange={handleChangeCountryStateCity}>
          ...
          <div className=' inp'>
            <select className='w-[21.5rem] border focus:outline-none rounded-md lg:w-full md:w-full select_op text-sm flex items-center  p-3' name="minDistances" value={locationModel.minDistances} onChange={handleChangeCountryStateCity}>
          ...
          <div className=' inp'>
            <select className='w-[21.5rem] border focus:outline-none rounded-md lg:w-full md:w-full select_op text-sm flex items-center  p-3' name="maxDistances" value={locationModel.maxDistances} onChange={handleChangeCountryStateCity}>
          ...
          <div className=''>
            <button
              ...
              style={{  fontSize: '13px', fontWeight: "600" }} className='bg-[#DC3545] h-full w-full rounded-md text-white'>Search</button>
          </div>
          <div>
            <button onClick={() => setservicePopup(true)} className='bg-[#DC3545] lg:p-1 p-2 w-full  rounded-md text-white text-[13px] font-medium  lg:h-full h-[95%] '>Add Service</button>
          </div>
